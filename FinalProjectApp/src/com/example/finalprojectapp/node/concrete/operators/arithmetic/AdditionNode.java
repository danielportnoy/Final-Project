...
/**
 * Holds the Logical data and functionality of a Addition 'Code part'.
...
public class AdditionNode extends Node{
	...
	/**
	 * Logical and Graphic data and functionality of the left button for a Addition 'Code part'.
	 * @author daniel portnoy
	 *
	 */
	...
	/**
	 * Logical and Graphic data and functionality of the right button for a Addition 'Code part'.
	 * @author daniel portnoy
	 *
	 */
