...
/**
 * Holds the Logical data and functionality of a Equals 'Code part'.
...
public class EqualsNode extends Node {
	...
	public List<CodeWritingPart> getCodeWritingParts() {
		...
		// Add the equals sign (==).
		res.add(new CodeWritingPart(false, false, Constants.EQUALS_CODE_TEXT, null, this));
	...
	public List<CodeRunningPart> getCodeRunningParts(Node target,boolean isHighlighted) {
		...
		// Add the equals sign (==).
		res.add(new CodeRunningPart(false, false,isHighlighted, Constants.EQUALS_CODE_TEXT));
	...
	/**
	 * Logical and Graphic data and functionality of the left button for a Equals 'Code part'.
	 * @author daniel portnoy
	 *
	 */
	...
	/**
	 * Logical and Graphic data and functionality of the right button for a Equals 'Code part'.
	 * @author daniel portnoy
	 *
	 */
