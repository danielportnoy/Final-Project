...
/**
 * Holds the Logical data and functionality of a Division 'Code part'.
...
public class DivisionNode extends Node{
	...
	public List<CodeWritingPart> getCodeWritingParts() {
		...
		res.add(new CodeWritingPart(false, false, Constants.DIVISION_CODE_TEXT, null, this));
	...
	public List<CodeRunningPart> getCodeRunningParts(Node target, boolean isHighlighted) {
		...
		// Add the division sign (/).
		res.add(new CodeRunningPart(false, false,isHighlighted, Constants.DIVISION_CODE_TEXT));
	...
	public ReturnObject run() throws MyException {
		...
		try {	
			res = left.run().getIntValue() / right.run().getIntValue();
		}
	...
	/**
	 * Logical and Graphic data and functionality of the left button for a Division 'Code part'.
	 * @author daniel portnoy
	 *
	 */
	...
	/**
	 * Logical and Graphic data and functionality of the right button for a Division 'Code part'.
	 * @author daniel portnoy
	 *
	 */
