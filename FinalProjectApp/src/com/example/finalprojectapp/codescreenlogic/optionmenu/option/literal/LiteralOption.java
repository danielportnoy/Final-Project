package com.example.finalprojectapp.codescreenlogic.optionmenu.option.literal;
...
import com.example.finalprojectapp.nodetree.node.literal.BoolLiteralNode;
import com.example.finalprojectapp.nodetree.node.literal.IntLiteralNode;
...
public class LiteralOption extends Option{
	...
	public boolean isType(Type type) {
		List<Type> types = OptionsDB.getByNodeType(NodeType.Literal);
