...
import com.example.finalprojectapp.Android_Utils;
import com.example.finalprojectapp.R;
import com.example.finalprojectapp.codescreenlogic.CodeScreenManager;
import com.example.finalprojectapp.codescreenlogic.codescreen.CodeLine;
	...
	private void handleSetter(LinearLayout codeLinearLayout,final Setter setter) {
		...
		button.setOnClickListener(new OnClickListener() {				
			...
			public void onClick(View v) {
				CodeScreenManager.getInstance().SetterClick(setter);
			}
		});
